...
success:function(response){
  ...
  $("#cart-item").html(response);
          ...
          <section class="heade">
            <div class="container">
                <div class="row">
                    <a href="http://localhost/rental_cloth_shop/men.php"><p class="cat">Blazers</p></a>
                    <a href="http://localhost/rental_cloth_shop/kurtas.php"><p class="cat">kurtas</p></a>
                    <a href="http://localhost/rental_cloth_shop/Sherwani.php"><p class="cat">Sherwani</p></a>
          ...
          <section class="section7">
             ...
             $procat='men';
             $sherwani='sherwani';
$sql=mysqli_query($con,"select * from product where procat='$procat' && subprocat='$sherwani'");
