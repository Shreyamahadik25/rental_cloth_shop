...
// $rentproprice=$_POST['RentalPrice'];
...
$file_ext=strtolower(end($file_parts));
      ...
      $expensions= array("jpeg","jpg","png","AVIF","webp","avif"); 
...
$query=mysqli_query($con,"insert into product(proname,procat,subprocat,proprice,proquant,prodesc,proimg) values('$proname','$procat','$subprocat','$proprice','$proquant','$prodesc','$proimg')");
	if($query)
	{
...
{
?>
																<option value="<?php echo htmlentities($row1['subcatslug']);?>">
																	<?php echo htmlentities($row1['subcatname']);?>
																</option>
																<?php } ?>
