...
success:function(response){
  ...
  $("#cart-item").html(response);
          ...
          <section class="heade">
            <div class="container">
                <div class="row">
                    <a href="http://localhost/rental_cloth_shop/girl.php"><p class="cat">Lehenga</p></a>
                    <a href="http://localhost/rental_cloth_shop/frocks.php"><p class="cat">Frocks</p></a>
                    <a href="http://localhost/rental_cloth_shop/trad2.php"><p class="cat">Traditional costumes</p></a>
                </div>
            </div>
          </section>
...
$sql=mysqli_query($con,"select * from product where procat='$procat' && subprocat='$traditional'");
